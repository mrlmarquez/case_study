...
with st.expander(
    ...
    ```json
    {
        ...
        "incoming_clause": "DURATION OF TERM: The initial lease term shall be fifteen (15) years, starting on April 1, 2011 (the 'Commencement Date'). If the TENANT is not in default under the terms of this Lease, the TENANT shall have the option to extend the Lease for an additional fifteen (15) years (the 'Secondary Term'), beginning immediately after the expiration of the Primary Term. To exercise this option, the TENANT must send written notice to the LANDLORD by Certified Mail, no earlier than two hundred ten (210) days and no later than one hundred eighty (180) days prior to the end of the Primary Term.",
        "country": "Germany",
        "max_retries": 3
    }
    """
